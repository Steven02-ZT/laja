...
function History() {
    return (
        <div data-aos="zoom-in-left" className='bg-center bg-cover h-fit md:h-[80vh] mt-12 flex items-center justify-center p-3 relative'
        style={window.innerWidth >=1100 ? {backgroundImage:`url(lajas/background.jpeg)`}: {}}>
