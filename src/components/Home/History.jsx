...
function History() {
    return (
        <div data-aos="zoom-in-left" className='bg-center bg-cover md:g-[url(lajas/background.jpeg)] h-fit md:h-[80vh] mt-12 flex items-center justify-center p-3'>
            <div data-aos="zoom-in-right" className='w-full bg-white h-full grid md:grid-cols-12 items-center gap-2'
